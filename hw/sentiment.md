...
In the starter kit, I provide sample HTML files, [sample-parrt-tweets.html](https://github.com/USFCA-MSDS/msds692/blob/master/hw/code/sentiment/sample-parrt-tweets.html) and [sample-parrt-following.html](https://github.com/USFCA-MSDS/msds692/blob/master/hw/code/sentiment/sample-parrt-following.html).
...
Download the [starterkit](https://github.com/USFCA-MSDS/msds692/tree/master/hw/code/sentiment), which has the following files and structure (from `tree` commandline tool):
